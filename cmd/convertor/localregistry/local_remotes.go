...
type LocalResolver struct {
	testReg *LocalRegistry
}

func NewMockLocalResolver(ctx context.Context, localRegistryPath string) (*LocalResolver, error) {
	reg, err := NewLocalRegistry(ctx, RegistryOptions{
...
func NewLocalResolver(ctx context.Context, testReg *LocalRegistry) (*LocalResolver, error) {
	return &LocalResolver{
		testReg: testReg,
	}, nil
}

func (r *LocalResolver) Resolve(ctx context.Context, ref string) (string, v1.Descriptor, error) {
...
func (r *LocalResolver) Fetcher(ctx context.Context, ref string) (remotes.Fetcher, error) {
...
func (r *LocalResolver) Pusher(ctx context.Context, ref string) (remotes.Pusher, error) {
...
func (f *LocalFetcher) Fetch(ctx context.Context, desc v1.Descriptor) (io.ReadCloser, error) {
...
func (p LocalPusher) Writer(ctx context.Context, opts ...content.WriterOpt) (content.Writer, error) {
	return nil, errors.New("Not implemented")
}

func (p LocalPusher) Push(ctx context.Context, desc v1.Descriptor) (content.Writer, error) {
	return p.push(ctx, desc, remotes.MakeRefKey(ctx, desc), false)
}

func (p LocalPusher) push(ctx context.Context, desc v1.Descriptor, ref string, unavailableOnFail bool) (content.Writer, error) {
